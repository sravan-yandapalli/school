...
console.log("Server ENV:", {
    ...
    hasSecret: !!process.env.AWS_SECRET_ACCESS_KEY // Sensitive! Only log for debugging
});

// Environment variables (SERVER-SIDE ONLY)
const REGION = process.env.AWS_REGION!; // Use AWS_REGION, not NEXT_PUBLIC_*
const TABLE_NAME = process.env.DYNAMODB_CAMP_TABLE!;
const ACCESS_KEY_ID = process.env.AWS_ACCESS_KEY_ID!; // Sensitive!
const SECRET_ACCESS_KEY = process.env.AWS_SECRET_ACCESS_KEY!; // Sensitive!
